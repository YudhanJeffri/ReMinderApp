...
class DetailListAdapter(val mData: ArrayList<DetailMapelModel>) : RecyclerView.Adapter<DetailListAdapter.ViewHolderDetail>() {
    ...
    class ViewHolderDetail(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item: DetailMapelModel) {
            with(itemView) {
                ...
                tanggal_deadline.text = item.deadline_tanggal
